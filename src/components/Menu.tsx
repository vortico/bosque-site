import { BosqueIcon, GithubIcon } from '@/components/icons'
...
function Logo() {
  return (
    <Link href="/" className="flex items-center justify-start gap-2 text-brand-500" aria-label="Bosque logo">
      <BosqueIcon className="h-5 w-5 lg:h-6 lg:w-6" />
      <span className="text-xl lg:text-2xl">Bosque</span>
    </Link>
  )
}
